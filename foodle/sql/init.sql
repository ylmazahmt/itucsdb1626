...
DROP TABLE IF EXISTS users, user_emails, user_activations, user_images, places, place_images, posts, post_likes, user_friends, check_ins, post_images, post_comments, place_instances, check_in_comments, place_ratings, chat_rooms, chat_room_messages, cities CASCADE;
